...
local function slashHandler(option)
    if option == "menu" then
        InterfaceOptionsFrame_OpenToCategory("BigAuras")
    else
        print("Valid command is: /bigauras menu")
    end
end

function Config:OnInitialize()
    loadOptions()
    LibStub("AceConfigRegistry-3.0"):RegisterOptionsTable("BigAuras", options)
    LibStub("AceConfigDialog-3.0"):AddToBlizOptions("BigAuras", "BigAuras")
    LibStub("AceConsole-3.0"):RegisterChatCommand("bigauras", slashHandler)
end
