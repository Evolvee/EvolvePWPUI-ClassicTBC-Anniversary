...
addon.addonTitle = "Loss of Control Alerter"
  ...
  profile = {
    ...
    debuffs = {
      ...
      debuffsTable = {
		...
		{ spellId = 19229, category = "Snared", weight = 1, active = true, type = 1 },     --[[ Wing Clip Root --]]
		{ spellId = 27067, category = "Snared", weight = 1, active = true, type = 1 },     --[[ Counterattack Root --]]
		{ spellId = 19185, category = "Snared", weight = 1, active = true, type = 1 },     --[[ Entrapment --]]
		{ spellId = 33395, category = "Snared", weight = 1, active = true, type = 1 },     --[[ Freeze (Pet) --]]

        { spellId = 18469, category = "Silenced", weight = 4, active = true, type = 2 }, --[[ Imp Counterspell --]]
        { spellId = 15487, category = "Silenced", weight = 4, active = true, type = 2 }, --[[ Silence --]]
        { spellId = 34490, category = "Silenced", weight = 4, active = true, type = 2 }, --[[ Silencing Shot --]]
        { spellId = 1330, category = "Silenced", weight = 4, active = true, type = 2 },  --[[ Garrote --]]
        { spellId = 19647, category = "Silenced", weight = 4, active = true, type = 2 }, --[[ Spell Lock --]]
        ...
        { spellId = 10308, category = "Stunned", weight = 3, active = true, type = 3 },  --[[ Hammer of Justice --]]
		...
		{ spellId = 20549, category = "Stunned", weight = 3, active = true, type = 3 },  --[[ War Stomp racial tauren --]]
		{ spellId = 30153, category = "Stunned", weight = 3, active = true, type = 3 },  --[[ Felguard Stun --]]
		{ spellId = 30195, category = "Stunned", weight = 3, active = true, type = 3 },  --[[ Felguard Stun --]]
		{ spellId = 30197, category = "Stunned", weight = 3, active = true, type = 3 },  --[[ Felguard Stun --]]
		{ spellId = 39796, category = "Stunned", weight = 3, active = true, type = 3 },  --[[ Stoneclaw totem --]]
		{ spellId = 20170, category = "Stunned", weight = 3, active = true, type = 3 },  --[[ Seal of Justice stun --]]
		{ spellId = 19410, category = "Stunned", weight = 3, active = true, type = 3 },  --[[ Concussive Shot Stun --]]
		{ spellId = 16922, category = "Stunned", weight = 3, active = true, type = 3 },  --[[ Starfire Stun --]]
		...
		{ spellId = 27068, category = "Incapacitated", weight = 2, active = true, type = 4 }, --[[ Wyvern Sting --]]
        { spellId = 20066, category = "Incapacitated", weight = 2, active = true, type = 4 }, --[[ Repentence --]]
        { spellId = 38764, category = "Sapped", weight = 2, active = true, type = 4 },        --[[ Gouge --]]
        { spellId = 19503, category = "Disoriented", weight = 2, active = true, type = 4 },   --[[ Scatter Shot --]]
        { spellId = 2094, category = "Disoriented", weight = 2, active = true, type = 4 },    --[[ Blind --]]
        { spellId = 12825, category = "Polymorphed", weight = 2, active = true, type = 4 },   --[[ Polymorph --]]
        { spellId = 6213, category = "Feared", weight = 2, active = true, type = 4 },         --[[ Fear --]]
        ...
        { spellId = 14309, category = "Frozen", weight = 2, active = true, type = 4 },        --[[ Freezing Trap --]]
      }
    }
  }
}
