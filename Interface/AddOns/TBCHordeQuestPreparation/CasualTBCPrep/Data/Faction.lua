...
function CasualTBCPrep.Faction.GetPlayerFactionID()
    ...
    if "Horde" == factionTag then facID = 1
    elseif "Alliance" == factionTag then facID = 2
    else CasualTBCPrep.NotifyUserError("Unknown faction: "..factionTag..", using NEUTRAL(0) instead")
    end
