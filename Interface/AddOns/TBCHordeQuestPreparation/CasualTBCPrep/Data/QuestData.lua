...
local questsMetadata = {
	...
	[4509] = { id=4509, name="Calm Before the Storm", baseexp=790, exp=0, qlvl=54, type="turnin", preQuests="4494,4496,4507", routes="Main,Strat,Solo", routePickup="TanarisTown", routeSection="OrgrimmarDrag", areaType="Zone", area="Tanaris", },
	[4511] = { id=4511, name="Calm Before the Storm", baseexp=11800, exp=0, qlvl=54, type="turnin", preQuests="4494,4496,4507", routes="Main,Strat,Solo", routePickup="OrgrimmarDrag", routeSection="OrgrimmarBank", areaType="City", area="Orgrimmar", },
	[6822] = { id=6822, name="The Molten Core", baseexp=14300, exp=0, qlvl=60, type="qlog", preQuests="6804,6805,6821", replacementQuest=6824, routes="Main,Strat", routeSection="BayOfStorms", areaType="Raid", area="The Molten Core", },
	...
	[7826] = { id=7826, name="A Donation of Wool", baseexp=960, exp=0, qlvl=60, type="turnin", reqItems="2592-60", routes="Main,Strat,Solo", routePickup="OrgrimmarDrag", routeSection="OrgrimmarDrag", areaType="City", area="Orgrimmar", },
	[7827] = { id=7827, name="A Donation of Silk", baseexp=2400, exp=0, qlvl=60, type="turnin", reqItems="4306-60", routes="Main,Strat,Solo", routePickup="OrgrimmarDrag", routeSection="OrgrimmarDrag", areaType="City", area="Orgrimmar", },
	[7831] = { id=7831, name="A Donation of Mageweave", baseexp=4750, exp=0, qlvl=60, type="turnin", reqItems="4338-60", routes="Main,Strat,Solo", routePickup="OrgrimmarDrag", routeSection="OrgrimmarDrag", areaType="City", area="Orgrimmar", },
	[7824] = { id=7824, name="A Donation of Runecloth", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="14047-60", routes="Main,Strat,Solo", routePickup="OrgrimmarDrag", routeSection="OrgrimmarDrag", areaType="City", area="Orgrimmar", },
	...
	[5721] = { id=5721, name="The Battle of Darrowshire", baseexp=11900, exp=0, qlvl=60, type="qlog", reqItems="15209-1", preQuests="5149,5152,5153,5154,5210,5181,5168,5206,5941", routes="Main,Strat,Solo", routeSection="EPLDarrowshire", areaType="Zone", area="The Plaguelands", comments="Make sure you talk to Joseph Redpath after the event when preparing this quest. It should say (Complete) in your questlog" },
	[3507] = { id=3507, name="Betrayed", baseexp=10550, exp=0, qlvl=56, type="turnin", preQuests="3504,3505,3506", routes="Solo", routeSection="OrgrimmarDrag", areaType="Zone", area="Azshara", },
	...
	[7142] = { id=7142, name="The Battle for Alterac", baseexp=0, exp=0, qlvl=51, type="qlog", routes="Main,Strat,Solo", routeSection="AV", areaType="Battleground", area="Alterac Valley", isScaling=true, scaleRank=3, comments="Added in 3.15, Battleground Quest Scaling was tested on PTR. This quest is 14.3k at 60, 14.7k at 61 and 15k at 62. This makes it the quest with the most exp in the game right now" },
	[8272] = { id=8272, name="Hero of the Frostwolf", baseexp=0, exp=0, qlvl=51, type="turnin", routes="Main,Strat,Solo", routePickup="AV", routeSection="AV", areaType="Battleground", area="Alterac Valley", isScaling=true, scaleRank=1, comments="Added in 3.15, Battleground Quest Scaling was tested on PTR." },
	[7101] = { id=7101, name="Towers and Bunkers", baseexp=0, exp=0, qlvl=51, type="optional", routes="Main,Strat,Solo", routeSection="AV", areaType="Battleground", area="Alterac Valley", isScaling=true, scaleRank=1, comments="Added in 3.15, Battleground Quest Scaling was tested on PTR." },
	[7124] = { id=7124, name="Capture a Mine", baseexp=0, exp=0, qlvl=51, type="optional", routes="Main,Strat,Solo", routeSection="AV", areaType="Battleground", area="Alterac Valley", isScaling=true, scaleRank=1, comments="Added in 3.15, Battleground Quest Scaling was tested on PTR." },
	[7082] = { id=7082, name="The Graveyards of Alterac", baseexp=0, exp=0, qlvl=51, type="optional", routes="Main,Strat,Solo", routeSection="AV", areaType="Battleground", area="Alterac Valley", isScaling=true, scaleRank=1, comments="Added in 3.15, Battleground Quest Scaling was tested on PTR." },
	...
	[8430] = { id=8430, name="Battle of Warsong Gulch", baseexp=9550, exp=0, qlvl=60, type="disabled", reqItems="20558-3", routes="Main,Strat,Solo", routeSection="AV", areaType="Battleground", area="Warsong Gulch", comments="This quest was added from the EXTRAS tab, ROUTING IS NOT SUPPORTED. It is included in the Turnin RXP Guide." },
	[8439] = { id=8439, name="Conquering Arathi Basin", baseexp=9550, exp=0, qlvl=60, type="disabled", reqItems="20559-3", routes="Main,Strat,Solo", routeSection="AV", areaType="Battleground", area="Arathi Basin", comments="This quest was added from the EXTRAS tab, ROUTING IS NOT SUPPORTED. It is included in the Turnin RXP Guide." },
	[8369] = { id=8369, name="Invaders of Alterac Valley", baseexp=11900, exp=0, qlvl=60, type="disabled", reqItems="20560-3", routes="Main,Strat,Solo", routeSection="AV", areaType="Battleground", area="Alterac Valley", comments="This quest was added from the EXTRAS tab, ROUTING IS NOT SUPPORTED. It is included in the Turnin RXP Guide." },
	...
	[7650] = { id=7650, name="Enchanted Thorium Platemail: Volume II", baseexp=14300, exp=0, qlvl=60, type="disabled", reqItems="18770-1", reqProf=164, reqProfSkill=300, routes="Main,Strat,Solo", routeSection="ExtraFeature", areaType="Dungeon", area="Dire Maul", comments="This quest was added from the EXTRAS tab, ROUTING IS NOT SUPPORTED. Our RXP turnin guide will NOT turn in this quest, you MUST plan this yourself" },
	[7651] = { id=7651, name="Enchanted Thorium Platemail: Volume III", baseexp=14300, exp=0, qlvl=60, type="disabled", reqItems="18771-1", reqProf=164, reqProfSkill=300, routes="Main,Strat,Solo", routeSection="ExtraFeature", areaType="Dungeon", area="Dire Maul", comments="This quest was added from the EXTRAS tab, ROUTING IS NOT SUPPORTED. Our RXP turnin guide will NOT turn in this quest, you MUST plan this yourself" },
	...
	[7632] = { id=7632, name="The Ancient Leaf", baseexp=14300, exp=0, qlvl=60, type="disabled", reqItems="18703-1", playerClass="HUNTER", routes="Main,Strat,Solo", routePickup="felwoodTown", routeSection="felwoodTown", areaType="Raid", area="The Molten Core", comments="This quest was added from the EXTRAS tab, ROUTING IS NOT SUPPORTED. Our RXP turnin guide will NOT turn in this quest, you MUST plan this yourself" },
	[7506] = { id=7506, name="The Emerald Dream...", baseexp=14300, exp=0, qlvl=60, type="disabled", reqItems="18364-1", playerClass="DRUID", routes="Main,Strat,Solo", routeSection="felwoodTown", areaType="Dungeon", area="Dire Maul", comments="This quest was added from the EXTRAS tab, ROUTING IS NOT SUPPORTED. Our RXP turnin guide will NOT turn in this quest, you MUST plan this yourself" },
	[7503] = { id=7503, name="The Greatest Race of Hunters", baseexp=14300, exp=0, qlvl=60, type="disabled", reqItems="18361-1", playerClass="HUNTER", routes="Main,Strat,Solo", routeSection="felwoodTown", areaType="Dungeon", area="Dire Maul", comments="This quest was added from the EXTRAS tab, ROUTING IS NOT SUPPORTED. Our RXP turnin guide will NOT turn in this quest, you MUST plan this yourself" },
	[7500] = { id=7500, name="The Arcanist's Cookbook", baseexp=14300, exp=0, qlvl=60, type="disabled", reqItems="18358-1", playerClass="MAGE", routes="Main,Strat,Solo", routeSection="felwoodTown", areaType="Dungeon", area="Dire Maul", comments="This quest was added from the EXTRAS tab, ROUTING IS NOT SUPPORTED. Our RXP turnin guide will NOT turn in this quest, you MUST plan this yourself" },
	[7501] = { id=7501, name="The Light and How To Swing It", baseexp=14300, exp=0, qlvl=60, type="disabled", reqItems="18359-1", playerClass="PALADIN", routes="Main,Strat,Solo", routeSection="felwoodTown", areaType="Dungeon", area="Dire Maul", comments="This quest was added from the EXTRAS tab, ROUTING IS NOT SUPPORTED. Our RXP turnin guide will NOT turn in this quest, you MUST plan this yourself" },
	[7504] = { id=7504, name="Holy Bologna: What the Light Won't Tell You", baseexp=14300, exp=0, qlvl=60, type="disabled", reqItems="18362-1", playerClass="PRIEST", routes="Main,Strat,Solo", routeSection="felwoodTown", areaType="Dungeon", area="Dire Maul", comments="This quest was added from the EXTRAS tab, ROUTING IS NOT SUPPORTED. Our RXP turnin guide will NOT turn in this quest, you MUST plan this yourself" },
	[7498] = { id=7498, name="Garona: A Study on Stealth and Treachery", baseexp=14300, exp=0, qlvl=60, type="disabled", reqItems="18356-1", playerClass="ROGUE", routes="Main,Strat,Solo", routeSection="felwoodTown", areaType="Dungeon", area="Dire Maul", comments="This quest was added from the EXTRAS tab, ROUTING IS NOT SUPPORTED. Our RXP turnin guide will NOT turn in this quest, you MUST plan this yourself" },
	[7505] = { id=7505, name="Frost Shock and You", baseexp=14300, exp=0, qlvl=60, type="disabled", reqItems="18363-1", playerClass="SHAMAN", routes="Main,Strat,Solo", routeSection="felwoodTown", areaType="Dungeon", area="Dire Maul", comments="This quest was added from the EXTRAS tab, ROUTING IS NOT SUPPORTED. Our RXP turnin guide will NOT turn in this quest, you MUST plan this yourself" },
	[7502] = { id=7502, name="Harnessing Shadows", baseexp=14300, exp=0, qlvl=60, type="disabled", reqItems="18360-1", playerClass="WARLOCK", routes="Main,Strat,Solo", routeSection="felwoodTown", areaType="Dungeon", area="Dire Maul", comments="This quest was added from the EXTRAS tab, ROUTING IS NOT SUPPORTED. Our RXP turnin guide will NOT turn in this quest, you MUST plan this yourself" },
	[7499] = { id=7499, name="Codex of Defense", baseexp=14300, exp=0, qlvl=60, type="disabled", reqItems="18357-1", playerClass="WARRIOR", routes="Main,Strat,Solo", routeSection="felwoodTown", areaType="Dungeon", area="Dire Maul", comments="This quest was added from the EXTRAS tab, ROUTING IS NOT SUPPORTED. Our RXP turnin guide will NOT turn in this quest, you MUST plan this yourself" },
	[7507] = { id=7507, name="Nostro's Compendium", baseexp=14300, exp=0, qlvl=60, type="disabled", reqItems="18401-1", routes="Main,Strat,Solo", routeSection="felwoodTown", areaType="Dungeon", area="Dire Maul", comments="This quest was added from the EXTRAS tab, ROUTING IS NOT SUPPORTED. Our RXP turnin guide will NOT turn in this quest, you MUST plan this yourself" },
	[3782] = { id=3782, name="Morrowgrain Research", baseexp=680, exp=0, qlvl=50, type="turnin", routes="Main,Strat,Solo", routePickup="ThunderBluff", routeSection="ThunderBluff", areaType="Zone", area="Thunder Bluff", },
	[3786] = { id=3786, name="Morrowgrain Research", baseexp=6800, exp=0, qlvl=50, type="turnin", reqItems="11040-10", routes="Main,Strat,Solo", routePickup="ThunderBluff", routeSection="ThunderBluff", areaType="Zone", area="Thunder Bluff", },
}
