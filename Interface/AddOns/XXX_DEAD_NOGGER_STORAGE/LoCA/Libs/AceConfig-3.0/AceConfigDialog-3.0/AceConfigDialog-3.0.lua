...
function AceConfigDialog:AddToBlizOptions(appName, name, parent, ...)
	...
	if not BlizOptions[appName][key] then
		...
		local group_name = name or appName
		...
		--local category, layout = Settings.RegisterVerticalLayoutCategory(group_name)
		--Settings.RegisterCategory(category)
		--Settings.RegisterCanvasLayoutSubcategory(category, group.frame, appName)
		local category = Settings.RegisterCanvasLayoutCategory(group.frame, group_name)
